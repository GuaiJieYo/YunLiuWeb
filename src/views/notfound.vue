...
@button-bg-color: #68c950;
@button-hover-bg-color: #5A5C6C;
...
.generate-animations(@count) when (@count > 0) {
    #Polygon-@{count} {
        .float-animation();
        animation-delay: unit(@count * 0.2, s);
    }

    .generate-animations(@count - 1);
}

.generate-animations(5);
